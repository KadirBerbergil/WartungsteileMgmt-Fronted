// src/pages/machines/MachineMaintenanceWorkflow.tsx - Clean Professional Design
    ...
    return (
      <div className="space-y-6">
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Wartungsanalyse läuft</h3>
          <p className="text-gray-600">System analysiert Maschinenspezifikationen und generiert Wartungsteileliste...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="space-y-6">
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-red-600 mb-2">Systemintegration fehlgeschlagen</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">Wartung durchführen</h1>
      ...
      {currentStep === 'analysis' && (
        <div className="space-y-6">
          <div className={`bg-white rounded-lg border-2 p-6 ${
            analysis.urgency === 'high' ? 'border-red-200' :
            analysis.urgency === 'medium' ? 'border-amber-200' :
            'border-green-200'
          }`}>
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                  ...
                  analysis.urgency === 'medium' ? 'bg-amber-50' :
                  'bg-green-50'
                }`}>
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Wartungsanalyse</h2>
                  <p className={`text-sm ${
              ...
              <div className="text-right">
                <div className="text-2xl font-bold text-gray-900">{analysis.totalPossibleCosts.toFixed(0)}€</div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-lg font-semibold text-gray-900">{analysis.machineAgeYears} Jahre</p>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="font-medium text-gray-900 mb-2">Analyse-Report:</h3>
          ...
          <div className="flex justify-end">
            <button
              onClick={nextStep}
              className="inline-flex items-center space-x-2 bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 font-medium rounded-lg transition-colors"
            >
      ...
      {currentStep === 'parts' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div className="bg-blue-50 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium text-blue-900">Aktuell ausgewählt:</h3>
                    <p className="text-blue-700 text-sm">{selectedParts.length} Teile</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-blue-900">{calculateTotalCosts().toFixed(2)}€</div>
                    <div className="text-blue-700 text-sm">Gesamtkosten</div>
                  </div>
                </div>
              </div>
                          ...
                          <div className="flex items-center space-x-3">
                            <div className="flex items-center space-x-2">
                              <button
                                ...
                                className="w-8 h-8 bg-white border border-red-300 text-red-600 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center rounded-lg"
                              >
                            ...
                            <div className="text-right min-w-[70px]">
                              <p className="font-medium text-gray-900 text-sm">{selectedPart ? (selectedPart.price * selectedPart.quantity).toFixed(2) : '0.00'}€</p>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {partsList.recommendedParts.map((part, index) => {
                      ...
                      return (
                        <div key={index} className={`flex items-center justify-between p-4 border rounded-lg transition-all cursor-pointer ${
                          isSelected 
                            ...
                            <div className="flex items-center space-x-3">
                              <div className="flex items-center space-x-2">
                                <button
                                  ...
                                  className="w-8 h-8 bg-white border border-amber-300 text-amber-600 hover:bg-amber-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center rounded-lg"
                                >
                                  <MinusIcon className="h-4 w-4" />
                                </button>
                              ...
                              <div className="text-right min-w-[70px]">
                                <p className="font-medium text-gray-900 text-sm">{(selectedPart.price * selectedPart.quantity).toFixed(2)}€</p>
                                <p className="text-xs text-gray-500">Gesamt</p>
                              </div>
                            </div>
                          )}
              ...
              {partsList.requiredParts.length === 0 && partsList.recommendedParts.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Keine Wartungsteile erforderlich</h3>
                  <p className="text-gray-600">Das System hat für diese Maschine keine Wartungsteile gefunden.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex justify-between">
            <button
              onClick={prevStep}
              className="inline-flex items-center space-x-2 border border-gray-300 text-gray-700 px-6 py-2 font-medium rounded-lg hover:bg-gray-50 transition-colors"
            >
              <ArrowLeftIcon className="h-4 w-4" />
            ...
            <button
              ...
              className="inline-flex items-center space-x-2 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-400 text-white px-6 py-2 font-medium rounded-lg transition-colors disabled:cursor-not-allowed"
            >
      ...
      {currentStep === 'confirm' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Wartung bestätigen</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium text-gray-700 mb-2">Maschine</h3>
                  <p className="text-gray-900">{machine.number} - {machine.type}</p>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{selectedParts.length} Teile ausgewählt</p>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm max-h-40 overflow-y-auto">
                  ...
                  <div className="flex justify-between font-semibold text-lg border-t pt-2">
                    <span>Gesamt:</span>
                    <span className="text-gray-900">{calculateTotalCosts().toFixed(2)}€</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  {selectedParts.map((part, index) => (
                    <div key={index} className="flex items-center justify-between text-sm">
                      <div className="flex items-center space-x-2">
                        <span className={`w-2 h-2 rounded-full ${part.isRequired ? 'bg-red-500' : 'bg-amber-500'}`}></span>
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              className="inline-flex items-center space-x-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white px-8 py-2 font-medium rounded-lg transition-colors disabled:cursor-not-allowed"
            >
              {isPerforming ? (
                <>
      ...
      {currentStep === 'complete' && (
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Wartung abgeschlossen</h2>
          ...
          <div className="bg-green-50 rounded-lg p-4 mb-6 max-w-lg mx-auto">
          ...
          <div className="flex justify-center space-x-4">
            <Link 
              to={`/machines/${id}`}
              className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 font-medium rounded-lg transition-colors"
            >
              Zurück zur Maschine
            </Link>
            <Link 
              to="/machines"
              className="border border-gray-300 text-gray-700 px-6 py-2 font-medium rounded-lg hover:bg-gray-50 transition-colors"
            >
              Zu allen Maschinen
            </Link>
          </div>
