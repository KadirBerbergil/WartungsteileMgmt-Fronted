// src/pages/machines/PdfUploadExtractor.tsx - Clean Professional Design
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Dokument-Upload</h1>
      ...
      {step === 'upload' && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          >
            ...
            <label
              htmlFor="pdf-upload"
              className="inline-flex items-center px-4 py-2 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors cursor-pointer"
            >
      ...
      {step === 'processing' && (
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Verarbeitung läuft</h3>
      ...
      {step === 'batch-creating' && (
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Erstellung läuft</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white border border-green-300 rounded-lg p-4">
              <div className="text-2xl font-bold text-green-600 mb-1">{batchResult.successfullyCreated}</div>
              <div className="text-green-700 font-medium text-sm">Erfolgreich erstellt</div>
            </div>
            <div className="bg-white border border-red-300 rounded-lg p-4">
              <div className="text-2xl font-bold text-red-600 mb-1">{batchResult.failed}</div>
              <div className="text-red-700 font-medium text-sm">Fehlgeschlagen</div>
            </div>
            <div className="bg-white border border-blue-300 rounded-lg p-4">
              <div className="text-2xl font-bold text-blue-600 mb-1">{batchResult.totalMachines}</div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 max-h-60 overflow-y-auto">
                <div className="space-y-2">
                  {batchResult.results.map((result, index) => (
                    <div key={index} className="flex items-center justify-between py-2 px-3 bg-white border border-gray-200 rounded-lg">
                      <div className="flex items-center">
                        {result.success ? (
